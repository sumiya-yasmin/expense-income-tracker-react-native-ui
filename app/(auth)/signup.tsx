...
import { View, Text, TextInput, TouchableOpacity, Image, ImageSourcePropType, ScrollView } from "react-native";
    ...
    <View className="p-6 pt-12">
      ...
      <View className="flex-row justify-center items-center mb-6">
        ...
        <TouchableOpacity 
          ...
          activeOpacity={0.7}
        >
          <Image source={APPLE_ICON} className="w-8 h-8" resizeMode="contain" />
        </TouchableOpacity>
        ...
        <TouchableOpacity 
          ...
          activeOpacity={0.7}
        >
          <Image source={GOOGLE_ICON} className="w-8 h-8" resizeMode="contain" />
        </TouchableOpacity>
      </View>
      ...
      <View className="flex-row justify-center">
        ...
        <TouchableOpacity onPress={goToLogin}>
          <Text className="text-green-600 text-base font-semibold">Log in</Text>
        </TouchableOpacity>
      </View>
    </View>
    </ScrollView>
